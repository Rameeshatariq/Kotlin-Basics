...
// So how can we solve this? We could do a null check before hand
    ...
    if(nullableName2 != null) {
     //   System.out.println("Hello, ${nullableName2.toLowerCase()}.")
        System.out.println("Your name is ${nullableName2.length} characters long.")
    } else {
...
// You can use methods on a nullable variable like this
   ...
   // System.out.println(nullableName3?.toLowerCase()) // prints null
    System.out.println(nullableName3?.length) // prints null
