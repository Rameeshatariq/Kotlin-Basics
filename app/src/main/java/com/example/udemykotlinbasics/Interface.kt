package com.example.udemykotlinbasics
...
interface Driveable {
    ...
    fun drive(): String
    fun brake(){
        System.out.println("The drivable is braking")
    }
}

// Class Car which extends the interface
open class Interface(override val maxSpeed: Double,
    ...
    override fun drive(): String {
        System.out.println("Drove for $range KM")
...
class ElectricCars(override val maxSpeed: Double,
                  override val brandName: String,
                  batteryLife: Double) : Interface(maxSpeed, brandName) {
    ...
    fun drive(distance: Double){
        System.out.println("Drove for $distance KM on electricity")
    }
    override fun brake(){
        System.out.println("The electirc car is breaking")
    }
}
...
fun main(args: Array<String>){
    var audiA3 = Car("", "Audi")
    var teslaS = ElectricCar("", "Tesla", 85.0)
